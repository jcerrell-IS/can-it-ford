...
RULES: list[Rule] = [
    ...
    Rule("C10c", ERROR,
         ...
         "TOPPLE has ratio >= 1 in 12 and triggers in 0. Counting runs by ratio >= 1 "
         "reports 12 topples that never happened. That tally read 13 until the G "
         "unification of 2026-08-12 (register A6): g48_m2337 fell from 1.000244 to "
         "0.999903 and NO verdict moved, which is this rule's point in miniature.",
