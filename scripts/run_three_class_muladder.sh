...
# Published field range is roughly 0.25 to 0.78 (Shah 2018 measured 0.52 sliding;
...
TAG=${1:-2026-08-14}
BASE=/scratch/11603/jcerrell0629/three_class_muladder_${TAG}
...
run_one MU_silverado_n154_m2270_mu0p40 silverado 154 2270.0 0.40 "friction ladder"
run_one MU_silverado_n154_m2270_mu0p45 silverado 154 2270.0 0.45 "friction ladder"
run_one MU_silverado_n154_m2270_mu0p50 silverado 154 2270.0 0.50 "friction ladder"
