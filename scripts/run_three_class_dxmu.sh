...
TAG=${1:-2026-08-14}
BASE=/scratch/11603/jcerrell0629/three_class_dxmu_${TAG}
...
run_one MU_silverado_n96_m2270_mu0p30 silverado 96 2270.0 0.30 "closes the (dx,mu) square: coarse grid at the safety convention"
