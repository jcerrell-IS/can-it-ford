...
FIG = os.path.join(REPO, "figures", "_BIG_GRIDAWARE")
...
def g1(inv):
    ...
    fig, ax = plt.subplots(figsize=(7.500, 4.300))
...
def g3(gates):
    ...
    fig, ax = plt.subplots(figsize=(8.750, 4.100))
...
def g5(inv, dry):
    ...
    fig, ax = plt.subplots(figsize=(7.500, 4.400))
...
def g7(inv):
    ...
    fig, (axl, axr) = plt.subplots(1, 2, figsize=(8.750, 4.300),
    ...
    rows = [
        ...
        ("fill_ratio vs 0.95 to 1.10 band", "%.4f at g64 only; %.4f to %.4f (17 runs in render_s2)"
...
def g8():
    ...
    fig, ax = plt.subplots(figsize=(7.500, 4.600))
    ax.imshow(img)
    ax.axis("off")
...
def g9(inv):
    ...
    fig = plt.figure(figsize=(8.750, 4.800))
