...
**First completed MPM run, July 10.** simulation/box_sdf_collider_setup.py, kks32/mpm-engine, sedan-scale box (4.66x1.79x1.44m), full 1.0s / 500 steps, exit 0. Floor plane raised to floor_z=3*dx to clear the P2G stencil margin, root cause of the prior step-0 crash. Peak force 6389.93 N at t=0.166s (water slug impact), settling to ~2000-2500 N steady streamwise drag with y-axis pitch torque, physically consistent with a sedan box facing flow. Log: logs/sdf_run_july10_floorfix.txt. Commit 8fa6fc7.
