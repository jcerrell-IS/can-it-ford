...
**Version 3a, released December 2016**
...
[doi:10.13021/G8SC8K]: https://doi.org/10.13021/G8SC8K "2007 Chevrolet Silverado
Finite Element Model Validation Coarse Mesh"
...
2. set-silverado-coarse-v3a.key
  
  This file is used to set the simulation parameters. Simple modifcations can
  be made to this file to run different impact configurations. The file
  includes:
