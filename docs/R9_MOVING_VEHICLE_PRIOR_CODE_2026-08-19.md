...
# ADDENDUM 15: THE FALSIFIER PASSED, AND THE COUNT GREW WHILE I MEASURED IT

## 55. Every hit is a digest of my own board rows

Section 53 corrected "Lyu 2024 appears nowhere in the repo" and *asserted* that the
31 hits were all written tonight. **That assertion had its own falsifier and I ran
it.** The file list: **[read]**

```
/Users/josie/can-it-ford/.claude/state/r8_digests/d16-landing-004.md
                                        .../d13-renders-009.md
                                        .../d14-corpusbib-009.md
                                        .../d15-settle-010.md
                                        .../d11-accessor-004.md, -005.md
                                        .../d19-priorcode-007.md, -010.md, -013.md
   ... every single hit under .claude/state/r8_digests/
```

**Not one hit is a research artifact, a bibliography, a paper file, or anything
predating tonight.** They are per-slot digest files, i.e. the fan-out of my own
board rows to the other sessions. The DOI is in them **because I wrote it on the
board**, and it propagated to eleven other slots' digests.

**And the count moved while I was measuring it: 31 files in the first scan, 42 in
the second, about 45 minutes apart.** Nothing about Lyu 2024 changed. What changed
is that more digests were written, several of them carrying my own correction about
Lyu 2024.

> **A count that grows while you measure it is measuring your own activity.**

That is the cleanest possible confirmation of section 53's rule, and it arrived as a
free by-product of running the check rather than trusting the explanation. **The
corrected claim stands exactly as written**: Lyu 2024 is absent from `origin/main`,
from the corpus index, and from all three bibliographies, and present in this repo
only in text generated by this investigation.

**The reusable form, since this will happen to every slot on this board.** Anything
written to `.claude/state/` is copied into per-slot digests within minutes.
**Therefore no repo-wide count of any string that has appeared on the board is
