...
> |---|---|---|---|---|
> | 1 | **CCSA/NCAC geometry.** 4 original distribution archives (88,592,238 B) + 14 extracted decks (71,716,670 B), redistributed **intact**, not derived | 160,322,098 B | Licence **silent**: no grant, no licence name, no copyright statement | **every public branch** |
...
>
> Separately, the credential FLAG document is public on **exactly one** branch while
> the geometry is on **every** branch. Stated as invariants, not counts: the total grew
> 30 to 35 to 36 between 2026-08-16 and 08-19, so any figure quoting it is stale on
> arrival. Same reason: one remediation shape does not fit both.
...
| `WRL reports technical and Research/` Figure 5-5, Table 5-1, Table 5-2 | 3 | 760,091 | 0.76 | **CLEARED 2026-08-18** by the blanket grant Josie reports. Source: **WRL Technical Report 2014/07, UNSW Water Research Laboratory, September 2014.** Identified 2026-08-18 from Table 5-1's own page footer. The H1-H6 flood hazard vulnerability classification. **A fourth rights holder**, distinct from Engineers Australia |
...
- **I did not check the other 29 public branches** for `citations/` variants. The
  geometry sweep showed the public surface is 36 branches, not one tree, and this
