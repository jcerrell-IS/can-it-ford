...
| `R5_RESEARCH_FORCE_CONVERGENCE_2026-08-19.md` | **the publishable one**: force-vs-resolution curve, 4 grids x N=5. Does NOT converge; 8 of 9 successive changes exceed 10% against a 0.0-2.8% noise floor |
