...
| 19 | the FORD/NO-FORD evidentiary asymmetry is "the single most valuable thing found in this whole dispatch" | unit 16 §1 | **DOWNGRADED. 0 of 3 references support it; 1 of 3 checked and it does not.** Easterling 2001's abstract addresses no asymmetry. **Do not put it in the paper on this evidence.** The same read did yield a solid primary source for "model validation is not binary" | unit 17 |
