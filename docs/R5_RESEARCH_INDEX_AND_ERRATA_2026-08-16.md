...
| `R5_RESEARCH_FRICTION_055_PROVENANCE_2026-08-19.md` | **for D4**: our `floor_friction=0.55` is **1.83x** the mu=0.3 the AR&R curves rest on; chain terminus (SAE 690214) absent from the repo |
